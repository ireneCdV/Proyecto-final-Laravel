...
<body class="antialiased">
    <div
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            ...
            @else
            <a href="{{ route('login') }}"
                class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Inicia
                Sesion</a>
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img src="imagenes/logo.jpg" alt="Logo" height="150px" width="150px">
            </div>
            <br>
            <div class="py-12">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <p>
                                ...
                                suminiestrados por el proveedor oficial. Si necesita planchas, secadores, máquinas de
                                corte,
                                utensilios de peluqueria y todo lo relacionado a este sector; somos los indicados para
                                ofrecerle
                            ...
                            <p>
                                ...
                                económicos; de
                                esta manera podemos ofrecer productos de peluquería y estética baratos, ya sea por
                                unidad o por
                                grupo de artículos. Todos los pedidos que salen de nuestros almacenes se comprueban para
                                que
                            ...
                            <p>
                                ...
                                originales y nuevos. Si un cliente recibe un producto en mal estado o dañado, deberá
                                ponerse en
                            ...
                            <p>
                                ...
                                Siempre que el pedido se realice antes de las 14:00 le llegará entre 1 y 3 días
                                laborales en la
                                península. Si el pedido se demora nos pondremos en contacto con antelación para ver si
                                hay
                                alguna incidencia con el pedido en cuestión. En este vídeo explicativo puedes consultar
                                nuestra
                                Política de Entrega.
                            </p>
                        </div>
            ...
            <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                ...
                <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }}) Irene Campillos
                    del Valle
                </div>
            </div>
        </div>
