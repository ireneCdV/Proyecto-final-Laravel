            ...
            <div class="flex w-full">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex justify-between items-center w-full">
                    <div class="space-x-8 items-center">
                        ...
                        <x-nav-link :href="route('crudadmins.index')" :active="request()->routeIs('crudadmins.index')">
                            {{ __('Gestion Admin') }}
                        </x-nav-link>

                        <x-nav-link :href="route('crudproducts.index')" :active="request()->routeIs('crudproducts.index')">
                            {{ __('Gestion Productos') }}
                        </x-nav-link>

                        <x-nav-link :href="route('crudcitas.index')" :active="request()->routeIs('crudcitas.index')">
                            {{ __('Gestion Citas') }}
                        </x-nav-link>

                        <x-nav-link :href="route('crudcategories.index')" :active="request()->routeIs('crudcategories.index')">
                            {{ __('Gestion Categorias') }}
                        </x-nav-link>

                        <x-nav-link :href="route('crudservices.index')" :active="request()->routeIs('crudservices.index')">
